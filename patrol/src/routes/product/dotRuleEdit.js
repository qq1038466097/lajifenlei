...
const DotRuleEdit = ({
  ...
  const { listData,infos } = dotRuleEdit;
...
export default connect(({ dotRuleEdit }) => ({ dotRuleEdit }))(Form.create()( DotRuleEdit ))
